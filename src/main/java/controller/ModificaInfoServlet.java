	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(mode.equalsIgnoreCase("update")) {
			if(target.equalsIgnoreCase("utente")) {
				...
				out.append(username + "|" + password + "|" + passwordCheck + "|" + email + "|" + nome + "|" + cognome + "\n");
				...
				try {
					...
					if(!metodoPagamento.getNome().equalsIgnoreCase(nome)) {
						metodoPagamento.setNome(nome);
					}
					
					if(!metodoPagamento.getCognome().equalsIgnoreCase(cognome)) {
						metodoPagamento.setCognome(cognome);
					}
					
					if(!metodoPagamento.getDataScadenza().equalsIgnoreCase(dataScadenza)) {
						metodoPagamento.setDataScadenza(dataScadenza);
					}
					
					if(!metodoPagamento.getCvv().equalsIgnoreCase(cvv)) {
